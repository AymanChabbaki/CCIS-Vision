...
ALTER FUNCTION public.calculate_company_quality_score(company_uuid uuid) OWNER TO neondb_owner;
...
ALTER FUNCTION public.clean_email(raw_email text) OWNER TO neondb_owner;
...
ALTER FUNCTION public.clean_ice_number(raw_ice text) OWNER TO neondb_owner;
...
ALTER FUNCTION public.clean_phone_number(raw_phone text, add_prefix boolean) OWNER TO neondb_owner;
...
ALTER FUNCTION public.find_duplicate_companies(company_name character varying, company_ice character varying) OWNER TO neondb_owner;
...
ALTER FUNCTION public.find_name_duplicates(similarity_threshold double precision) OWNER TO neondb_owner;
...
ALTER FUNCTION public.find_potential_duplicates(check_company_id uuid) OWNER TO neondb_owner;
...
ALTER FUNCTION public.import_companies_from_raw(import_log_uuid uuid) OWNER TO neondb_owner;
...
ALTER FUNCTION public.is_valid_email(email text) OWNER TO neondb_owner;
...
ALTER FUNCTION public.log_audit_trail() OWNER TO neondb_owner;
...
ALTER FUNCTION public.merge_companies(keep_company_id uuid, merge_company_id uuid, merged_by_user_id uuid) OWNER TO neondb_owner;
...
ALTER FUNCTION public.normalize_company_name(raw_name text) OWNER TO neondb_owner;
...
ALTER FUNCTION public.parse_excel_date(raw_date text) OWNER TO neondb_owner;
...
ALTER FUNCTION public.validate_all_companies() OWNER TO neondb_owner;
...
ALTER TABLE public.activity_partners OWNER TO neondb_owner;
...
ALTER TABLE public.alert_recipients OWNER TO neondb_owner;
...
ALTER TABLE public.alert_types OWNER TO neondb_owner;
...
ALTER SEQUENCE public.alert_types_id_seq OWNER TO neondb_owner;
...
ALTER SEQUENCE public.budget_categories_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.company_sectors OWNER TO neondb_owner;
...
ALTER SEQUENCE public.company_sectors_id_seq OWNER TO neondb_owner;
...
ALTER MATERIALIZED VIEW public.dashboard_stats OWNER TO neondb_owner;
...
ALTER TABLE public.data_quality_issues OWNER TO neondb_owner;
...
ALTER TABLE public.data_quality_rules OWNER TO neondb_owner;
...
ALTER SEQUENCE public.data_quality_rules_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.formations OWNER TO neondb_owner;
...
ALTER TABLE public.kpi_definitions OWNER TO neondb_owner;
...
ALTER SEQUENCE public.kpi_definitions_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.partner_types OWNER TO neondb_owner;
...
ALTER SEQUENCE public.partner_types_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.raw_excel_data OWNER TO neondb_owner;
...
ALTER SEQUENCE public.service_types_id_seq OWNER TO neondb_owner;
...
ALTER TABLE public.services_provided OWNER TO neondb_owner;
...
ALTER TABLE public.training_categories OWNER TO neondb_owner;
...
ALTER SEQUENCE public.training_categories_id_seq OWNER TO neondb_owner;
...
ALTER VIEW public.v_activities_summary OWNER TO neondb_owner;
...
ALTER VIEW public.v_companies_incomplete OWNER TO neondb_owner;
...
ALTER VIEW public.v_companies_with_quality OWNER TO neondb_owner;
...
ALTER VIEW public.v_company_quality_overview OWNER TO neondb_owner;
...
ALTER VIEW public.v_duplicate_companies_by_ice OWNER TO neondb_owner;
...
ALTER VIEW public.v_import_quality_report OWNER TO neondb_owner;
...
ALTER VIEW public.v_monthly_statistics OWNER TO neondb_owner;
